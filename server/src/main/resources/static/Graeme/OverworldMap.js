...
window.OverworldMaps = {
    Outside: {
        id: "Outside",
        lowerSrc: "/Graeme/images/maptileset/samplemap/samplemap.png",
        upperSrc: "/Graeme/images/maptileset/samplemap/samplemapupper.png",
        gameObjects: {
            hero: new Person({
            ...
            doggo: new Person({
                x: utils.withGrid(9),
                y: utils.withGrid(15),
                src: "/Graeme/images/characters/animal/doggo.png",
                talking: [
                    {
                        events: [
            ...
            farmer_girl: new Person({
                x:utils.withGrid(7),
                y:utils.withGrid(7),
                src: "/Graeme/images/characters/female/farmer_girl.png",
                behaviourLoop: [
            ...
            guard: new Person({
                x:utils.withGrid(7),
                y:utils.withGrid(19),
                src: "/Graeme/images/characters/soldier/guard.png",
                behaviourLoop: [
            ...
            grieving_son: new Person({
                x:utils.withGrid(23),
                y:utils.withGrid(4),
                src: "/Graeme/images/characters/male/grieving_son.png",
                behaviourLoop: [
    ...
    Farmhouse_Entrance: {
        ...
        lowerSrc: "/Graeme/images/maptileset/farmhouse_main.png",
        upperSrc: "/Graeme/images/maptileset/farmhouse_main_upper.png",
        gameObjects: {
            hero: new Person({
                isPlayerControlled: true,
            }),
    ...
    Farmhouse_Basement: {
        ...
        lowerSrc: "/Graeme/images/maptileset/farmhouse_basement_lower.png",
        upperSrc: "/Graeme/images/maptileset/farmhouse_basement_upper.png",
        gameObjects: {
            hero: new Person({
                isPlayerControlled: true,
            }),
